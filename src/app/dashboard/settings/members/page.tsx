  ...
  return (
    <div className="p-4 lg:p-8 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage individual member permissions.</p>
      </div>
      
      <div className="rounded-2xl border border-dashed border-border/60 bg-muted/20 h-[400px] flex items-center justify-center">
        <p className="text-muted-foreground text-sm font-medium">Members module is coming soon...</p>
      </div>
    </div>
  );
}
